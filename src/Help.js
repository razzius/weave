...
const Help = () => (
  <AppScreen className="resources">
    ...
    <p>
      ...
      cook, are they from the west coast, do they identify as an immigrant, were
      they also a first generation student, or do they share the same faith as
      you? In addition to empowering students and faculty to connect in this
      way, Weave allows mentors to clearly communicate their capacity for
      mentorship at a given point in time; faculty and student mentors may
      indicate their preferred meeting cadence, method of contact, and any
      additional opportunities offered so that mentees can enter with realistic
      expectations for each relationship. For more information, please visit the{' '}
    ...
    <ul>
      ...
      <li>
        ...
        , personal interests, or clinical interests (i.e. search for &quot;first
        generation,&quot; &quot;faith,&quot; &quot;music,&quot;
        &quot;running,&quot; etc.)
      </li>
      <li>
      ...
      <li>
        ...
        (i.e. Scholars in Medicine Office database for finding research mentors,
        Catalyst Clinical and Translational Research Database for finding
        research mentors, HMS Collaborate page where all of the residency
        advising resources are housed) - Check out the &quot;Resources&quot;
        page on Weave for these links and more
      </li>
      <li>
        <em>Ask faculty to speak at student interest group events</em> (look for
        the check box next to &quot;Student group support&quot;)
      </li>
      <li>
      ...
      <li>
        ...
        <em>faculty who have degrees that match what you may be considering</em>{' '}
    ...
    <p>
      ...
      the option to “View Faculty Mentor Profiles,” which will bring you to a
      searchable list of all faculty profiles. If there are faculty you wish to
      contact or whose profile you wish to make a special note of in Weave, you
      can star the profile for ease of finding later. These stars are only
      visible to you in your personal account and not to Weave administrators or
      faculty and students on Weave.
    </p>
    <p>
    ...
    <p>
      The synopsis of profiles shares a snapshot of faculty names, institutions,
      clinical interests, preferred meeting cadence (i.e. Biweekly, monthly,
      etc.), as well as additional opportunities displayed as checkboxes.
    </p>
    <h3>How do I view all student mentor profiles?</h3>
    <p>
      From the home page, you have the option to “View Student Mentor Profiles,”
      which will bring you to a searchable list of all student profiles. Similar
      to faculty profiles, you may also star student mentor profiles. These
      stars are only visible to you in your personal account and not to Weave
      administrators or faculty and students on Weave.
    </p>
    <p>
      The search feature at the top of the page allows for searching based on
      tags as well as free text. Additionally, you may filter by institution and
      sort profiles by starred profiles first, most recently updated,
    ...
    <p>
      ...
      Biweekly, monthly, etc.), as well as additional opportunities displayed as
      checkboxes.
    </p>
    ...
    <p>
      ...
      faculty and student mentors may join Weave at any point. Faculty with many
      mentees or who are on sabbatical and no longer available for mentoring for
      a certain period of time may hide their profiles from the search and “view
      profiles” page. Likewise, faculty who were previously unavailable may
      become available as their scheduling commitments allow. We recommend
      returning to Weave periodically for updates. You may sort profiles by most
      recently updated, and each profile notes the date when the profile was
      last updated.{' '}
    </p>
    ...
    <h3>
      I am having technical difficulties making a mentor profile on Weave. Which
      web browsers are supported with Weave?
    </h3>
    <p>
      ...
      Mozilla Firefox. Please contact us at {emailLink} if you experience
      technical difficulties using one of the supported web browsers.
    </p>
  </AppScreen>
)
