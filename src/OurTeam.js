...
const OurTeam = () => (
  <AppScreen className="resources">
    ...
    <p>In 2017, Weave was co-founded by Jie Jane Chen (Harvard MD Class of 2020) and Jonathan Kusner (Harvard MD Class of 2021), and built by Razzi Abuissa (software engineer). Jane, Jon, and Razzi are actively developing Weave to expand its offerings to students, residents, and faculty. Dr. Jennifer Potter (Advisory Dean for the William Bosworth Castle Society) and Dr. Fidencio Saldaña (Dean for Students) are advisors for this mentorship initiative, which is endorsed by the Office of Student Affairs at Harvard Medical School.</p>
