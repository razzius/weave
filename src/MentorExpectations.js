  ...
  return (
    <AppScreen>
      ...
      <p>
        ...
        relationship early in your correspondences. These terms do not have to
        be final but each member should have some sense of expectations about
        what the relationship will constitute in the dimensions of frequency
        meeting, method of correspondence, and content of what each party is
        hoping to invest and receive from the relationship. Let Weave serve as a
      ...
      <p>
        ...
        you develop your interests? What should mentees look for when
      ...
      <h3>Life happens</h3>
      <p>
        Do not be afraid to end the relationship if either you or your mentee
