...
profiles = [
    Profile(
        ...
        activities='Swimming,Wellness,West coast'.split(','),
        cadence='monthly',
    ),
    Profile(
        name='Falcon!!',
        ...
        activities='Cooking,Theater,Fiction'.split(','),
    ...
    Profile(
        ...
        activities='Art,Clinical trials,Mother'.split(','),
    ...
    Profile(
        ...
        activities='Cooking,Clinical trials,Health policy'.split(','),
    ...
    Profile(
        ...
        activities='Cooking,Health policy,Poetry'.split(','),
